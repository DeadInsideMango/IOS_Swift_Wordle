...
//  Wordle
//
//  Created by Roman Hairulin on 18/07/2023.
//
...
class KeyboardViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let letters = ["qwertyuiop", "asdfghjkI", "zxcvbnm"]
    ...
    let collectionView: UICollectionView = {
        ...
        collectionView.register(KeyCell.self, forCellWithReuseIdentifier: KeyCell.indentifier)
...
extension KeyboardViewController {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier:
                                                                KeyCell.indentifier, for: indexPath) as? KeyCell else {
            fatalError()
        }
